    ...
    public class TestPane extends JPanel implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getActionCommand()=="BFS"){
                res = implementBFS(grid, source, dest);
                this.repaint();
            }
        ...
        /**Adds or updates the nodes in the queue. 
         ...
         */
        public void addNeighbours(Nodes top, Queue<Nodes> queue, Nodes[][] grid) {
            if(top.row>0){
                if(!grid[top.row-1][top.col].isVisited && !grid[top.row-1][top.col].isWall){
                    if(!grid[top.row-1][top.col].inDatastructure){
                        ...
                        queue.add(grid[top.row-1][top.col]);
            ...
            if(top.col>0){
                if(!grid[top.row][top.col-1].isVisited && !grid[top.row][top.col-1].isWall){
                    if(!grid[top.row][top.col-1].inDatastructure){
                        ...
                        queue.add(grid[top.row][top.col-1]);
        ...
        private List<Nodes> implementBFS(Nodes[][] grid, Nodes source2, Nodes dest2) {
            ...
            /**adding source pointer to the queue*/
            queue.add(head);
