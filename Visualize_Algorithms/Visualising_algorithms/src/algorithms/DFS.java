    ...
    public class TestPane extends JPanel implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getActionCommand()=="DFS"){
                res = implementDFS(grid, source, dest);
                this.repaint();
            }
        ...
        /**Adds or updates the nodes in the stack. 
         ...
         */
        public void addNeighbours(Nodes top, Stack<Nodes> stack, Nodes[][] grid) {
            if(top.row>0){
                if(!grid[top.row-1][top.col].isVisited && !grid[top.row-1][top.col].isWall){
                    if(!grid[top.row-1][top.col].inDatastructure){
                        ...
                        stack.add(grid[top.row-1][top.col]);
            ...
            if(top.col>0){
                if(!grid[top.row][top.col-1].isVisited && !grid[top.row][top.col-1].isWall){
                    if(!grid[top.row][top.col-1].inDatastructure){
                        ...
                        stack.add(grid[top.row][top.col-1]);
        ...
        private List<Nodes> implementDFS(Nodes[][] grid, Nodes source2, Nodes dest2) {
            Stack<Nodes> stack = new Stack<>();
            Nodes head = Nodes.checkInGrid(grid, source2);
            if(head==null){
            ...
            /**adding source pointer to the stack*/
            stack.add(head);
            head.inDatastructure = true;

            /**performing DFS */
            while(!stack.isEmpty()){
                Nodes temp = stack.pop();
                temp.isVisited = true;
